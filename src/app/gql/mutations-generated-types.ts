...
export type RegisterMutation = { registration: Pick<Types.AuthResponse, 'token'> };
...
export type CreateTodoMutation = { createTodo: Pick<Types.Todo, 'completed' | 'description' | 'id' | 'tag' | 'title' | 'categoryId'> };
...
export type DeleteCategoryMutation = { deleteCategory: Pick<Types.Category, 'id' | 'title'> };
...
export type UpdateTodoMutation = { updateTodo: Pick<Types.Todo, 'completed' | 'description' | 'id' | 'tag' | 'title' | 'categoryId'> };
...
export type DeleteTodoMutation = { deleteTodo: Array<Pick<Types.Todo, 'id' | 'categoryId' | 'title'>> };
